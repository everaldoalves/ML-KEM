...
#define poly_basemul_montgomery1 KYBER_NAMESPACE(poly_basemul_montgomery1)
void poly_basemul_montgomery1(poly *r, const poly *a, const poly *b);

#define poly_basemul_montgomery KYBER_NAMESPACE(poly_basemul_montgomery)
void poly_basemul_montgomery(poly *r, const poly *a, const poly *b);

// Inserida a função com neon
#define poly_basemul_montgomery_neon KYBER_NAMESPACE(poly_basemul_montgomery_neon)
void poly_basemul_montgomery_neon(poly *r, const poly *a, const poly *b);
